...
async function startScan() {
  ...
  try {
    if (activeScanType === "image") {
      ...
      // Tunatumia Promise kusoma picha
      ...
      // Sasa tunatuma base64Image hiyo kwenye API
      ...
      // ... (logic yako ya kuonesha matokeo) ...
      result.innerHTML = `<b>Scan Imekamilika!</b><br>Verdict: ${data.ai.verdict}`;
